...
> **副業は顔出しせず、職場にも一切言わない**
>
> 副業ポリシーが OK / NG / 申請制のいずれでも、この原則は変わらない。
> 副業ポリシーの意味は **「バレた時のダメージの大きさ」** のみ。
> 全求人を**「隠す前提」で評価**すること。
>
> 詳細は LIFE_PLAN.md §15-8 を参照。
...
| 副業バレリスク | 同僚との接点 + 業界（ポリシーに依存しない） | ★★ |
| バレ時のダメージ | 副業ポリシー + 罰則の重さ | ★★ |
| 加齢適性 | 70 代まで継続可能性 + 厚生年金 + 退職金 | ★★ |
| 撤退柔軟性 | 試用期間 + 退職難易度 | ★ |
| 過去実績整合 | 過去の就職時の投稿空白との照合 | ★★ |

→ 「副業バレリスク」（バレるかどうか）と「バレ時のダメージ」（バレたら何が起こるか）
は **独立して評価**する。隠す前提で運用するので、両軸とも低い求人がベスト。
